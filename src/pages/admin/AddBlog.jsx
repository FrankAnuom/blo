  ...
  return (
    ...
    >
      <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
        ...
        <div className="max-w-lg h-74 pb-16 sm:pb-10 relative pt-2">
        ...
        <button
          disabled={isAdding}
          className="mt-8 w-20 h-10 bg-primary text-white rounded cursor-pointer text-sm"
          type="submit"
        >
          {isAdding ? "Adding..." : "Post"}
        </button>
      </div>
    </form>
  );
